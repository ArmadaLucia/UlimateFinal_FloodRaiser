...
namespace Digger
{
    public class DiggerSystem : MonoBehaviour
    {
        ...
        private int TerrainChunkWidth => Terrain.terrainData.heightmapWidth * master.ResolutionMult / Chunk.SizeOfMesh - 1;
        private int TerrainChunkHeight => Terrain.terrainData.heightmapHeight * master.ResolutionMult / Chunk.SizeOfMesh - 1;
